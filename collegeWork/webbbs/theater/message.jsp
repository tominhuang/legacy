...
%>
	<table width="95%" border="0" align="center" cellspacing="0">
	  <tr bgcolor="#3366cc" style="color:white">
			<td width="23%" colspan="4">【<a href="javascript:window.external.AddFavorite('http://tomin.twbbs.org/theater', '劇場組')" style="color:white">我的最愛</a>】　</td>
			<td width="*" align="center" colspan="2"><a href="good.jsp"><font color="Yellow">劇場組</font></a></td>
  	  		<td width="23%" align="right">【<a href="admin.jsp" style="color:white">版主</a>：<a href="http://tomin.wiki.ptt.cc/" target="_blank" style="color:white">土銘</a>】</td>
	  </tr>
      <tr>
        <th width="4%">編號</th>
        <th width="4%">精華</th>
