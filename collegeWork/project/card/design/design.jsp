...
<div align="center">
  ...
  <form name="form" method="post" action="design_deal.jsp">
    ...
    <p>Page:
        <select name="select">
          <option value="white.gif" selected="selected">White</option>
          <option value="purplemoon.gif">Purple Moon</option>
          <option value="pinkmoon.gif">Pink Moon</option>
          <option value="feathers.gif">Feathers</option>
          <option value="f1.gif">Flower 1</option>
          <option value="f2.gif">Flower 2</option>
          <option value="f3.gif">Flower 3</option>
          <option value="f4.gif">Flower 4</option>
          <option value="f5.gif">Flower 5</option>		  		  		  		  		  
        </select>        
        Card:
        <select name="select2">
          <option value="bluelove.gif" selected="selected">Blue Love</option>
          <option value="xflower.gif">X Flower</option>
          <option value="purplewall.gif">Purple Wall</option>
          <option value="yellowwall.gif">Yellow Wall</option>
          <option value="brownwall.gif">Brown Wall</option>

        </select>
    </p>
    <p>
        <input type="submit" name="Submit" value="Change" onClick="return checkdata()">
      <a href="advance.jsp">Advance</a></p>
  </form>
</div>