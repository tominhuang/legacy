...
public class AbstractDelete extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form
		    ...
		    File f = new File(abstractFile);
		    				
		    // Make sure the file or directory exists and isn't write protected
		    if (!f.exists()){
		    	xmlResponse = "<error>yes</error><errorType>no such file or directory: " + abstractFile + "</errorType>";
	    		xmlResponse += "<finish>0</finish>";
	    		xmlwriter.send(xmlResponse);
	    		return null;
		    };
